...
class InstructorMaintenanceScreen extends StatefulWidget {
  const InstructorMaintenanceScreen({super.key});

  @override
  State<InstructorMaintenanceScreen> createState() => _InstructorMaintenanceScreenState();
}

class _InstructorMaintenanceScreenState extends State<InstructorMaintenanceScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('My Maintenance Logs', style: GoogleFonts.epilogue(fontWeight: FontWeight.bold)),
        backgroundColor: Colors.white,
        elevation: 0,
        surfaceTintColor: Colors.white,
      ),
      body: StreamBuilder<List<MaintenanceReceiptModel>>(
        stream: instructorCtrl.getInstructorMaintenanceReceipts(),
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('No maintenance logs submitted yet.', style: GoogleFonts.epilogue(color: Colors.grey)),
                ],
              ),
            );
          }
                      ...
                      ClipRRect(
                        ...
                        child: Image.network(
                          ...
                          errorBuilder: (ctx, err, stack) => Container(
                            ...
                            child: Icon(Icons.build_circle_outlined, color: Colors.grey.shade400),
                          ),
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${receipt.description} • ${receipt.vehiclePlate}',
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => _showAddMaintenanceLogBottomSheet(context),
        backgroundColor: defaultBlue,
        elevation: 6,
        icon: const Icon(Icons.build_rounded, color: Colors.white),
        label: Text('Log Maintenance', style: GoogleFonts.epilogue(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
    );
  }
  ...
  void _showAddMaintenanceLogBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const _AddMaintenanceLogForm(),
    );
  }
}

class _AddMaintenanceLogForm extends StatefulWidget {
  const _AddMaintenanceLogForm();

  @override
  State<_AddMaintenanceLogForm> createState() => _AddMaintenanceLogFormState();
}

class _AddMaintenanceLogFormState extends State<_AddMaintenanceLogForm> {
    ...
    return Container(
      ...
      child: isSubmitting
          ...
          : Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Log Maintenance Bill', style: GoogleFonts.epilogue(fontSize: 20, fontWeight: FontWeight.bold)),
                    ...
                    child: receiptImage == null
                        ? Column(
                            ...
                            children: [
                              ...
                              Text('Tap to capture repair receipt', style: GoogleFonts.epilogue(color: Colors.grey)),
                            ],
                          )
                        : ClipRRect(
                            borderRadius: BorderRadius.circular(10),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      if (amountCtrl.text.isEmpty || descCtrl.text.isEmpty || selectedVehicle == null || receiptImage == null) {
                      ...
                      await instructorCtrl.submitMaintenanceReceipt(
                    ...
                    child: Text('Submit Maintenance Bill', style: GoogleFonts.epilogue(color: Colors.white, fontSize: 16)),
                  ),
                ),
                const SizedBox(height: 20),
              ],
