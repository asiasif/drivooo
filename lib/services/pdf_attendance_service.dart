...
class PdfAttendanceService {
  static Future<void> generate(AttendanceModel attendance) async {
            ...
            children: [
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text('Student ID: ${attendance.userID}',
                    ...
                    children: [
                      pw.Text('SESSION DETAILS',
                          style: pw.TextStyle(
                              fontWeight: pw.FontWeight.bold, fontSize: 10)),
                      pw.SizedBox(height: 5),
                      pw.Text('Trainer: ${attendance.trainerName}',
                          style: const pw.TextStyle(fontSize: 12)),
                    ],
                  ),
                ]
              ...
              pw.Row(
                ...
                children: [
                  ...
                  children: [
                    pw.Text('Driving School Verification',
                        style: pw.TextStyle(fontStyle: pw.FontStyle.italic, fontSize: 10)),
                    pw.Text('This is a computer generated slip.',
    ...
    await FileHandleApi.saveDocument(name: 'attendance_${attendance.attDate}_${attendance.attID}.pdf', bytes: await pdf.save());
  }
}
